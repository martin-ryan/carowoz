    ...
    configureGrunt = function (grunt) {
        ...
        var cfg = {
            ...
            watch: {
                livereload: {
                    files: [
                        'content/themes/caroline/assets/css/main.css',
                        'content/themes/caroline/assets/js/bundle.js',
                        'content/themes/caroline/*.hbs',
                        'content/themes/caroline/partials/*.hbs',
        ...
        grunt.registerTask('watch-docs', function () {
            grunt.config.merge({
                watch: {
                    docs: {
                        files: ['core/server/**/*', 'index.js', 'Gruntfile.js', 'config.js'],
                        tasks: ['docker'],
                        options: {
                            livereload: true
                        }
